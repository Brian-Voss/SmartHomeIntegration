      ...
      responseObserver =
          new ResponseObserver<StreamingRecognizeResponse>() {
            ...
            public void onResponse(StreamingRecognizeResponse response) {
              ...
              //this is where we need to patch in
              ...
              if (result.getIsFinal()) {
                ...
                //Need to patch into the assistant to respond to a know command if it came across
                
                
                VirtualAssistant assist = new VirtualAssistant();
                
                //search for the command to play
               String newCommand = assist.disectCommand(alternative.getTranscript());
               Optional<String> nullCheck = Optional.ofNullable(newCommand);
               if(nullCheck.isPresent())
               {
            	   DingPlayer.playDing();
            	   assist.speakToUser(newCommand.toString());
               }
